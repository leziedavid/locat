...
const Home = ({navigation}) => {
    ...
    return (
        <View style={{flex:1,top:180}}>

            <View style={styles.container}>

                <Portal>
                    <Modal  visible={visible} onDismiss={onHideModal}  contentContainerStyle={containerStyle}>
                        ...
                        <View style={{borderWidth:0, padding:15, borderRadius:0, backgroundColor:"#fff5e6", opacity:1, marginBottom:30}}>
                ...
                <View style={styles.card}>
                    ...
                    <View style={{backgroundColor:blue.normal, height:215, borderBottomLeftRadius:25, borderBottomRightRadius:25, justifyContent:"center", alignItems:"center", marginBottom:8}}>
                        <View style={{backgroundColor:"#fff", width:"90%", flexDirection:"row", padding:10, borderRadius:10}}>
                            <View style={{flex:1}}>
                                <View style={{flexDirection: "row", alignItems:"center", marginBottom:5}}>
                                    <MaterialCommunityIcons name="wallet" size={25} color={blue.normal} />
                                    <Text style={{fontSize:14, color:blue.normal, marginLeft:10,fontWeight:"bold"}}>SOLDE</Text>
                                </View>
                                <Text style={{fontWeight:"bold", fontSize:18, color:blue.normal, marginBottom:5}}>4 800 <Text style={{fontSize:12}}>CFA</Text></Text>
                                <Text style={{marginBottom:5,fontSize:9,color:blue.normal}}>A payer</Text>
                                <Text style={{fontWeight:"bold", fontSize:10, color:blue.normal, marginBottom:5}}>76.750 <Text style={{fontSize:8}}>CFA</Text></Text>
                            </View>
                            <View style={{flex:1, alignItems:"center", justifyContent:"center"}}>

                            <Button onPress={()=> navigation.navigate('Rechargement')} mode='contained' icon={"plus"} style={{backgroundColor: "white", borderWidth:1,borderRadius:8, borderColor: blue.normal, marginBottom:10, width:"80%", alignSelf:"center"}} labelStyle={{color:blue.normal, }}>
                                Recharger
                            </Button>
                            </View>
                        </View>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <Button  mode="contained"
                        style={[styles.button,  activeSection === 'transactions' ? styles.activeButton : styles.desactiveButton,]}
                ...
                {activeSection === 'loyer' && (
                    <ScrollView style={{ flex: 1,top:-208}}>

                            <View style={{flex:1, padding:10}}>

                                <TouchableOpacity style={{flexDirection:"row", backgroundColor:"#fff", padding:10, marginBottom:5,borderRadius:10}} onPress={()=> navigation.navigate('AdvancePayment')}>
                                        <View style={{flex:2.5, justifyContent:"flex-start", padding:5}}>
                                            ...
                                            <View style={{ flexDirection: 'row', alignItems: 'center',marginBottom: 8}}>
                                                <MaterialCommunityIcons name="check-circle" size={15} color={green.normal} />
                                                <Text style={{ color: green.normal, fontSize: 10 }}>Loyé payé d’avance</Text>
                                                
                                                <View style={ { backgroundColor: green.hover, padding: 5, borderRadius: 15, width: '30%', marginLeft: 10,}}>
                                            ...
                                            <Text>
                                            <Text style={{fontWeight:"bold",color: blue.normal ,fontSize:8}}> PERIODE : </Text> 
                                            <Text style={{color: blue.normal,fontSize:8}}>05 MARS - 05 Mai 2024</Text>
                                            
                                        </Text>
                                        
                                        </View>
                                        <View style={{flex:1, justifyContent:"center", alignItems:"center", padding:5}}>
                                            <Text style={{fontWeight:"bold", fontSize:10, color: blue.normal, marginBottom:35,marginLeft:-150,}}>MARS 2024 - Avril 2024 - Mai 2024</Text>
                                            <Text style={{fontSize:12, color: blue.normal, marginBottom:5}}> 3  mois </Text>
                                        </View>
                                ...
                                <TouchableOpacity style={{flexDirection:"row", backgroundColor:green.autre, padding:10, marginBottom: 5,borderRadius:10 }} onPress={()=> navigation.navigate('Nextmonth')}>
                                    <View style={{flex:2.5, justifyContent:"flex-start", padding:5}}>
                                        ...
                                        <View style={{backgroundColor: green.bg, padding:5, borderRadius:15, width:"40%", marginBottom:10}}>
                                    ...
                                    <View style={{flex:1, justifyContent:"center", alignItems:"center", padding:5}}>
                                        ...
                                        <View style={{backgroundColor: green.bg, padding:5, borderRadius:5}}>
                                            <Text style={{color:"#fff"}}>Paiement  </Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>

                                <TouchableOpacity style={{flexDirection:"row", backgroundColor:green.hover, padding:10, marginBottom:5,borderRadius:10}} onPress={()=> navigation.navigate('UnpaidRent')}>
                                    <View style={{flex:2.5, justifyContent:"flex-start", padding:5}}>
                                        <Text style={{ fontSize:10, marginBottom:10}}>Mon domicile</Text>

                                        <View style={{ flexDirection: 'row', alignItems: 'center',marginBottom: 8}}>
                                            <MaterialCommunityIcons name="close-circle" size={15} color={red.normal} />
                                            <Text style={{ color: red.normal, fontSize: 10 }}>LOYER  IMPAYE</Text>
                                            
                                            <View style={ { backgroundColor: green.hover, padding: 5, borderRadius: 15, width: '40%', marginLeft: 10,}}>
                                                <Text style={{ color:red.normal, fontSize: 5 }}>OFFRE -10% appliqué</Text>
                                            </View>
                                        ...
                                        <Text>
                                        <Text style={{fontWeight:"bold",color: blue.normal ,fontSize:8}}> PERIODE : </Text> 
                                        <Text style={{color: blue.normal,fontSize:8}}>05 JANVIER -05 FEVRIER</Text>
                                    </Text>
                                    
                                    </View>
                                    <View style={{flex:1, justifyContent:"center", alignItems:"center", padding:5}}>
                                        <Text style={{fontWeight:"bold", fontSize:10, color: blue.normal, marginBottom:5}}>MARS 2024</Text>
                                        <Text style={{fontSize:10, color: blue.normal, marginBottom:5}}>Mois en cours</Text>
                                ...
                                <TouchableOpacity style={{
                                    flexDirection:"row", backgroundColor:red.autre, padding:10, marginBottom:5,borderRadius:10
                ...
                {activeSection === 'transactions' && (
                    <View style={{flex:1, padding:10,top:-208}}>
                        <FlatList
                            data={transactions}
            ...
            <Snackbar  visible={visibleSnackbar}   onDismiss={onDismissSnackBar}  action={{ label: 'okay !',  onPress: () => { onDismissSnackBar();  }, }}  >
                Le code à été copié
            </Snackbar>
